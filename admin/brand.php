      ...
      <div class="row">
        <div class="col-md-12">
              ...
              <div class="card-header">
                ...
                <button type="button" name="add" id="add_brand" data-toggle="modal" data-target="#userModal" class="btn btn-primary btn-xs float-right">Add</button>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="form-group">
                <select name="category_id" id="category_id" class="form-control select_category" style="width: 100%;" required>
