          ...
          <div class="card-header">
           <div class="row">
            ...
            <a href="#" class="btn btn-danger btn-sm">General Summary</a>
             ...
             <a href="#" class="btn btn-info btn-sm">Client Statement</a>
...
<div class="col-md-3">
   <div class="input-group mb-3">
                  <input type="date" name="fromdategeneral" id="fromdategeneral"  class="form-control">
        ...
        <div class="col-md-3">
   <div class="input-group mb-3">
                  <input type="date" name="todategeneral" id="todategeneral"  class="form-control">
                  <div class="input-group-append">
        ...
        <div class="col-md-3">
                  ...
                  <input type="button" name="filterProductgeneral" id="filterProductgeneral" value="Filter" class="btn btn-primary">
        </div>
...
$('#filterProductgeneral').click(function(){

var fromdategeneral = $('#fromdategeneral').val();
var todategeneral = $('#todategeneral').val();
//var productcode = $('#productcode').val();

if(fromdategeneral != '' && todategeneral != '')
{
  $.ajax({
     url: "filter_product_report_general.php",
     method: "POST",
     data: {fromdategeneral:fromdategeneral, todategeneral:todategeneral},
