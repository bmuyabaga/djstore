...
if(isset($_POST["fromdategeneral"], $_POST["todategeneral"]))
{
	include('../config/function.php');

	$output = '';
	$query = " SELECT * FROM sales NATURAL JOIN sales_item NATURAL JOIN product  WHERE   date BETWEEN '".$_POST["fromdategeneral"]."' AND '".$_POST["todategeneral"]."' 
";
