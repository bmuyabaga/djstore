...
foreach($result as $row)
{
	...
	$sub_array[] = $status;
	$sub_array[] = '<button type="button" name="update" id="'.$row["brand_id"].'" class="btn btn-primary btn-xs update"><span class="fa fa-edit"></span></button>';
	$sub_array[] = '<button type="button" name="delete" id="'.$row["brand_id"].'" class="btn btn-danger btn-xs  delete" data-status="'.$row["brand_status"].'"><i class="fas fa-trash"></i></button>';
	$data[] = $sub_array;
}
